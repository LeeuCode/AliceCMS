...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div>
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/pages/update/'.$page->id; ?>/" method="post" >
                <?php get_csrf_input(); ?>
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <img id="Upload-Photo" src="<?php echo base_url().$page->banner; ?>" class="img-thumbnail" alt="">
                                <input id="uploadImage" class="imagUploder" name="banner" type="hidden" value="<?php echo $page->banner; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="layout" id="page-layout" class="form-control choose-layout">
                                    <?php foreach (page_layout() as $key => $value) : ?>
                                        <option value="<?php echo $key; ?>" <?php echo ($page->layout == $key) ? 'selected' : ''; ?> ><?php echo $value; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input  name="title" type="text" class="form-control" id="Page-Title" value="<?php echo $page->title; ?>" required >
                            </div>
                        </div>

                        <div class="form-group page-thumbnail" <?php echo ($page->layout == 'About-us' ) ? 'style="display:block;"' : ''; ?> >
                            <label for="Upload-Photo" class="col-sm-2 control-label text-right">Thumbnail</label>
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <input name="thumbnail" id="uploadThumbnail" class="form-control"  type="text" value="<?php echo $page->thumbnail; ?>" >
                        ...
                        <div class="form-group page-editor" <?php echo ($page->layout == 'Standard' || $page->layout == 'About-us' ) ? 'style="display:show;"' : 'style="display:none;"'; ?> >
                            <label for="Partner-Link" class="col-sm-2 control-label text-right">Page Content</label>
                            <div class="col-sm-9">
                                <textarea name="content" id="editor1" cols="30" rows="10"><?php echo $page->content; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="meta_keywords" type="text" class="form-control" id="meta-keywords" value="<?php echo $page->meta_keywords; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <textarea name="meta_description" width="100%" class="form-control" rows="3" id="meta-description" ><?php echo $page->meta_description; ?></textarea>
                            </div>
                        </div>
