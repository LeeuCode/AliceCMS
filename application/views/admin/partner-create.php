...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/partners/store/'; ?>" method="post" >
                <?php get_csrf_input(); ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input name="banner" id="uploadImage" type="hidden" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="partner_name" type="text" class="form-control" id="Partner-Name" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="partner_link" type="text" class="form-control" id="Partner-Name" >
                            </div>
                        </div>
