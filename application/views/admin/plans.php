...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="<?php echo base_url().'admin/plans/create/'; ?>" class="btn btn-primary btn-flat">
                    ...
                    <table class="table table-hover table-master">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <h4> <?php echo $plan->plan_price; ?> </h4>
                                </td>
                                <td>
                                    <h4><?php echo date('d/m/Y', strtotime($plan->created_at)); ?></h4>
                                </td>
                                <td>
                                    <a href="<?php echo base_url().'admin/plans/edit/'.$plan->id; ?>/" class="btn btn-sm btn-primary btn-flat">
                                        <i class="fa fa-edit" ></i>
                                    </a>
                                    <button type="button" data-toggle="modal" data-target="#modal-remove-<?php echo $plan->id; ?>"  class="btn btn-sm btn-danger btn-flat remove-item">
                                        <i class="fa fa-trash" ></i>
                                    </button>

                                    <form class="form-submit" action="<?php echo base_url().'admin/plans/delete/'.$plan->id; ?>/" method="post">
                                        <?php get_csrf_input(); ?>
                                        <div class="modal fade" id="modal-remove-<?php echo $plan->id; ?>">
