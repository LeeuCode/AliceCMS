...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div>
            ...
            <?php endif; ?>
            <form class="form-horizontal" action="<?php echo base_url().'admin/menus/store/'; ?>" method="post" >
                <?php  get_csrf_input(); ?>
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select name="menu_type" id="menu-type" class="form-control choose-menu-type ">
                                    ...
                                    <option value="page" >Menu From Page</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group choose-page">
                        ...
                        <div class="form-group other-menu ">
                        ...
                        <div class="form-group other-menu">
                            ...
                            <div class="col-sm-3">
                                <input name="menu_url" type="text" class="form-control" id="menu_url" >
                            </div>
                        </div>
                            ...
                            <div class="col-sm-3">
                                <select name="menu_parent" id="menu_parent" class="form-control">
                                    ...
                                    <?php foreach ($menus as $pMenu) : ?>
                                        <option value="<?php echo $pMenu->id; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input name="menu_order" type="number" class="form-control" id="menu_order" value="0" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        <input name="menu_header" type="checkbox" value="1" >
                                        Header Menu
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="menu_one" type="checkbox" value="1" >
                                        Footer Menu One
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="menu_two" type="checkbox" value="1">
                                        Footer Menu Two
                                    </label>
                                </div>                              
                            </div> 
