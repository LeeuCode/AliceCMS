...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/plans/update/'.$plan->id; ?>/" method="post" >
                <?php get_csrf_input(); ?>
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <a class="btn btn-app f-ico" data-toggle="modal" data-target="#choose-icon" >
                                    <i class="<?php echo $plan->plan_icon; ?>" ></i>
                                    Choose Icon
                                </a>

                                <input name="plan_icon" class="icon-input" type="hidden" value="<?php echo $plan->plan_icon; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="plan_name" type="text" class="form-control" id="Plan-Name" value="<?php echo $plan->plan_name; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="plan_price" type="text" class="form-control" id="Plan-Price" value="<?php echo $plan->plan_price; ?>" >
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="plan-items-container">
                                        ...
                                        $items = unserialize($plan->plan_items);
                                        // loop items data.
                                        foreach ($items as $item) :
                                            ?>
                                            <div class="col-md-7">
                                                <div class="input-group margin"> 
                                                    <input name="plan_items[]" class="form-control" type="text" value="<?php echo $item; ?>" >
