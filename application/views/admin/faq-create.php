...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/faqs/store/'; ?>" method="post" >
                <?php get_csrf_input(); ?>
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="title" type="text" class="form-control" id="FAQ-Title" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" class="form-control editor" rows="3" id="FAQ-Content" ></textarea>
                            </div>
                        </div>
