...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/members/store/'; ?>" method="post" >
                <?php get_csrf_input(); ?>
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <img id="Upload-Photo" src="<?php echo base_url().'assets/admin/'; ?>img/default-profile.jpg" class="img-thumbnail" alt="">
                        ...
                        <div class="form-group">
                            <label for="Member-Price" class="col-sm-2 control-label text-right">Member Career</label>
                            <div class="col-sm-4">
                                <input name="career" type="text" class="form-control" id="Member-Price" >
                            </div>
                        </div>
                                    ...
                                    <div class="Member-items-container">
                                        <div class="col-md-7">
                                            <div class="input-group margin ">
                                                ...
                                                <input name="socail_link[]" class="form-control" id="uploadscreenshot" type="text" >
                                                <span class="input-group-btn" >
