...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="col-md-6" >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/portfolios_categories/store/'; ?>" method="post" >
                <?php get_csrf_input(); ?>
                    ...
                    <table class="table table-hover table-master">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url().'admin/portfolios_categories/edit/'.$category->id; ?>/" class="btn btn-xs btn-primary btn-flat">
                                    ...
                                    <form class="form-submit" action="<?php echo base_url().'admin/portfolios_categories/delete/'.$category->id; ?>/" method="post">
                                        <?php get_csrf_input(); ?>
