...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div >
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/services/update/'.$service->id; ?>/" method="post">
                <?php get_csrf_input(); ?>  
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="icon" class="icon-input" value="<?php echo $service->icon; ?>" type="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <img id="Upload-Photo" src="<?php echo base_url().$service->image; ?>" class="img-thumbnail" alt="">
                                <input name="image" id="uploadImage" value="<?php echo $service->image; ?>" type="hidden" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="name" type="text" value="<?php echo $service->name; ?>" class="form-control" id="service-name" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="short_description" width="100%" class="form-control" rows="3" id="short-description" ><?php echo $service->short_description; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" class="form-control editor" rows="3" id="description" ><?php echo $service->content; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="meta_keywords" type="text" value="<?php echo $service->meta_keywords; ?>" class="form-control" id="meta-keywords" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="meta_description" width="100%" class="form-control" rows="3" id="meta-description" ><?php echo $service->meta_description; ?></textarea>
                            </div>
                        </div>
