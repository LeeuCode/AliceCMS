(function (factory) {
    ...
    var DataBasicPlugin = function (context) {
        ...
        context.memo(
            'button.databasicDialog', function () {
                return ui.button(
                    {
                        contents: self.icon,
        ...
        context.memo(
            'button.databasicSize100', function () {
                return ui.button(
                    {
        ...
        context.memo(
            'button.databasicSize50', function () {
                return ui.button(
                    {
        ...
        context.memo(
            'button.databasicSize25', function () {
                return ui.button(
                    {
        ...
        self.events = {
            'summernote.init': function (we, e) {
                ...
                $('data.ext-databasic', e.editable).each(
                    function () {
        ...
        self.setContent = function ($node) {
            $node.html(
                '<p contenteditable="false">' + self.icon + ' ' + lang.databasic.name + ': ' +
