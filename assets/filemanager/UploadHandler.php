...
class UploadHandler
{
    ...
    }//end set_additional_file_properties()
    ...
    }//end get_file_objects()


    protected function count_file_objects()
    {
        return count($this->get_file_objects('is_valid_file_object'));
    }//end count_file_objects()
    ...
    }//end get_scaled_image_file_paths()
    ...
    }//end imagick_destroy_image_object()
    ...
    }//end imagick_create_scaled_image()
    ...
    protected function imagemagick_create_scaled_image($file_name, $version, $options)
    {
        ...
        return true;
    }//end imagemagick_create_scaled_image()
    ...
    }//end send_access_control_headers()
    ...
    public function post($print_response = true)
    {
        ...
        $file_name                  = $content_disposition_header ? rawurldecode(
            preg_replace(
                '/(^[^"]+")|("$)/',
                '',
    ...
    public function onUploadEnd($res)
    {
        ...
        if ($is_img) {
            if (isset($this->options['config']['image_watermark']) && $this->options['config']['image_watermark']) {
                include_once 'include/php_image_magician.php';
            ...
            if ($thumbResult !== true) {
                ...
                if (!$this->options['ftp'] && ! new_thumbnails_creation($targetPath, $targetFile, $_FILES['files']['name'][0], $this->options['config']['current_path'], $this->options['config'])) {
                    ...
                    if ($this->options['config']['image_resizing']) {
                        if ($this->options['config']['image_resizing_width'] == 0) {
                            // if width not set
                        ...
                        } else if ($this->options['config']['image_resizing_height'] == 0) {
                            // if height not set
