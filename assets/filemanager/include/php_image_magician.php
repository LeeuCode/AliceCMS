...
class imageLib
{
    ...
    // Always be the original width
    private $heightOriginal;

    private $width;

    // Current width (width after resize)
    private $height;
...
/**
    ...
    *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    }//end calculateCaptionBoxPosition()
